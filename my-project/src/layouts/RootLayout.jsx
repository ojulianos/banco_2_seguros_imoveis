          ...
          <div className="flex justify-start items-center">
            ...
            <a href="/" className="flex items-center justify-between mr-4">
              <img
                ...
                alt="Flowbite Logo"
              />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Seguradoralider</span>
            </a>
      ...
      >
        <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
          <ul className="space-y-2">
            <li>
            <NavLink className={"flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"}
              to="/">
                              <svg
                  aria-hidden="true"
