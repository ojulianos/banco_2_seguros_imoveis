...
INSERT INTO apolices ([apo_cod], [apo_im_cod], [apo_cli_cod], [apo_dt_cad], [apo_dt_alt], [apo_dt_inicio_vigencia], [apo_dt_fim_vigencia], [apo_valor_cobertura], [apo_valor_franquia])
VALUES
    (1, 1, 1, null, null, '2023-02-01', '2024-01-31', 500000, 10000),
    (2, 2, 1, null, null, '2023-03-01', '2024-02-29', 400000, 8000),
    (3, 3, 1, null, null, '2023-04-01', '2024-03-31', 600000, 12000),
    (4, 4, 4, null, null, '2023-05-01', '2024-04-30', 550000, 11000),
    (5, 5, 5, null, null, '2023-06-01', '2024-05-31', 480000, 9600),
    (6, 6, 6, null, null, '2023-07-01', '2024-06-30', 520000, 10400),
    (7, 7, 7, null, null, '2023-08-01', '2024-07-31', 650000, 13000),
    (8, 8, 8, null, null, '2023-09-01', '2024-08-31', 470000, 9400),
    (9, 9, 8, null, null, '2023-10-01', '2024-09-30', 510000, 10200),
    (10, 10, 10, null, null, '2023-11-01', '2024-10-31', 590000, 11800),
    (11, 11, 11, null, null, '2023-12-01', '2024-11-30', 630000, 12600);


INSERT INTO apolice_itens ([api_cod], [api_apo_cod], [api_descricao])
VALUES
    ...
    (4, 4, 'Pellentesque eget mauris quis augue feugiat tincidunt. Vivamus pharetra, metus sit amet gravida posuere, magna mi rhoncus ligula, vitae fermentum elit enim id sapien. Fusce tristique volutpat sapien, id laoreet ipsum consequat ut. Donec hendrerit, lacus in efficitur eleifend, turpis odio hendrerit neque, a eleifend elit urna nec velit. In hac habitasse platea dictumst. Aliquam sagittis lectus et libero tincidunt, at laoreet risus dictum. Morbi id augue in lectus vulputate vulputate at id diam. Ut eget odio vehicula, aliquam ante eget, dictum neque. Nulla facilisi. Aenean eget erat sed est placerat sodales. Suspendisse potenti. Nam id risus ultricies, vulputate lectus nec, suscipit urna. Sed non velit vestibulum, consequat libero ut, consectetur justo.'),
    (5, 5, 'Proin vitae maximus purus. Sed ut turpis sit amet tortor congue placerat. Integer convallis magna nec ipsum consectetur facilisis. Duis mollis bibendum erat, vitae scelerisque ipsum feugiat vel. Vestibulum malesuada posuere sem, in egestas tortor laoreet nec. Nulla facilisi. Proin sodales justo a libero tincidunt, non eleifend magna dictum. Maecenas tincidunt nibh sit amet rhoncus tincidunt. Sed nec sem in ligula placerat consectetur id eu ligula. Aliquam erat volutpat. Etiam ac lacinia arcu, in tincidunt elit. Donec elementum magna a fermentum fringilla. Suspendisse lacinia purus a nibh luctus bibendum. Nullam vitae tristique metus. Donec tincidunt id ante sit amet tincidunt. Aliquam nec malesuada orci, vel ultrices magna. Donec ultricies, enim at scelerisque eleifend, elit enim luctus ligula, vitae laoreet lacus lorem eget odio.'),
    (6, 10, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
    (20, 5, 'Proin vitae maximus purus. Sed ut turpis sit amet tortor congue placerat. Integer convallis magna nec ipsum consectetur facilisis. Duis mollis bibendum erat, vitae scelerisque ipsum feugiat vel. Vestibulum malesuada posuere sem, in egestas tortor laoreet nec. Nulla facilisi. Proin sodales justo a libero tincidunt, non eleifend magna dictum. Maecenas tincidunt nibh sit amet rhoncus tincidunt. Sed nec sem in ligula placerat consectetur id eu ligula. Aliquam erat volutpat. Etiam ac lacinia arcu, in tincidunt elit. Donec elementum magna a fermentum fringilla. Suspendisse lacinia purus a nibh luctus bibendum. Nullam vitae tristique metus. Donec tincidunt id ante sit amet tincidunt. Aliquam nec malesuada orci, vel ultrices magna. Donec ultricies, enim at scelerisque eleifend, elit enim luctus ligula, vitae laoreet lacus lorem eget odio.');
...
VALUES
    ...
    (8, 4, null, 'foto8.jpg'),
    (9, 5, null, 'foto9.jpg'),
    (10, 5, null, 'foto10.jpg'),
    (11, 6, null, 'foto11.jpg'),
    (12, 6, null, 'foto12.jpg'),
    (13, 7, null, 'foto13.jpg'),
    (14, 7, null, 'foto14.jpg'),
    (15, 8, null, 'foto15.jpg');
...
INSERT INTO sinistro (sin_cod, sin_im_cod, sin_dt_cad, sin_hr_cad, sin_sit_cod, sin_tipo_cod) VALUES
  (1, 1, CURRENT_TIMESTAMP, null, 1, 1),
  (2, 2, CURRENT_TIMESTAMP, null, 2, 3),
  (3, 3, CURRENT_TIMESTAMP, null, 3, 2),
  (4, 4, CURRENT_TIMESTAMP, null, 1, 4),
  (5, 5, CURRENT_TIMESTAMP, null, 2, 5),
  (6, 6, CURRENT_TIMESTAMP, null, 3, 6),
  (7, 7, CURRENT_TIMESTAMP, null, 1, 7),
  (8, 8, CURRENT_TIMESTAMP, null, 2, 8),
  (9, 9, CURRENT_TIMESTAMP, null, 3, 9),
  (10, 10, CURRENT_TIMESTAMP, null, 1, 10),
  (11, 11, CURRENT_TIMESTAMP, null, 2, 4),
  (12, 12, CURRENT_TIMESTAMP, null, 3, 3),
  (13, 13, CURRENT_TIMESTAMP, null, 1, 5),
  (14, 14, CURRENT_TIMESTAMP, null, 2, 6),
  (15, 15, CURRENT_TIMESTAMP, null, 3, 7),
  (16, 1, CURRENT_TIMESTAMP, null, 1, 8),
  (17, 2, CURRENT_TIMESTAMP, null, 2, 9),
  (18, 3, CURRENT_TIMESTAMP, null, 3, 10),
  (19, 4, CURRENT_TIMESTAMP, null, 1, 2),
  (20, 5, CURRENT_TIMESTAMP, null, 2, 1),
  (21, 6, CURRENT_TIMESTAMP, null, 3, 4),
  (22, 7, CURRENT_TIMESTAMP, null, 1, 3),
  (23, 8, CURRENT_TIMESTAMP, null, 2, 5),
  (24, 9, CURRENT_TIMESTAMP, null, 3, 6),
  (25, 10, CURRENT_TIMESTAMP, null, 1, 7),
  (26, 1, CURRENT_TIMESTAMP, null, 2, 8),
  (27, 2, CURRENT_TIMESTAMP, null, 3, 9),
  (28, 1, CURRENT_TIMESTAMP, null, 1, 10),
  (29, 6, CURRENT_TIMESTAMP, null, 2, 2),
  (30, 10, CURRENT_TIMESTAMP, null, 3, 1);
